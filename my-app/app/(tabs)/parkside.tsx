...
export default function ParksideScreen() {
  ...
  const hallData = menuData.meals.breakfast['Parkside Restaurant & Grill']; // Adjust this line to fetch data for the desired hall
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Parkside Restaurant & Grill</Text>
